...
class CarcassoneNNet():
    ...
    def __init__(self, game, args):
        ...
        input_boards = Input(shape=(14, self.board_x, self.board_y))    # s: batch_size x board_x x board_y
        input_aux = Input(shape=(game.getAuxInputSize(),))

        x_image = Reshape((self.board_x, self.board_y, 14))(input_boards)                # batch_size  x board_x x board_y x 1
        ...
        # !!!!
        h_conv4_flat = concatenate([h_conv4_flat, input_aux])
